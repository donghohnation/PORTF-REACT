	...
	return (
		<div className="row rowow">
			...
			<div class="col d2about dotted-spaced" id="About Me">
				...
				<p class="sectiondescription">California based Graphic and UI/UX Designer and Web Developer, with extensive experience and proficiency in creating memorable experiences using these tools:
